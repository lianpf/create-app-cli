        ...
        if (!_fs2.default.existsSync(projectName)) {
            ...
            _inquirer2.default.prompt([{
                ...
                var _ref2 = _asyncToGenerator(function* (answer) {
                    //下载模板 选择模板
                    //通过配置文件，获取模板信息
                    let loading = (0, _ora2.default)((0, _constants.make_green)('downloading template ...'));
                    loading.start();
                    (0, _get.downloadLocal)(templateName, projectName).then(function () {
                        ...
                        if (_fs2.default.existsSync(fileName)) {
                            ...
                            console.log(_logSymbols2.default.success, (0, _constants.make_green)('Project init finished!'));
                        }
                    }).catch(function (err) {
                        console.log((0, _constants.make_red)('Project init fail:', err));
                        loading.fail();
                    });
                });
