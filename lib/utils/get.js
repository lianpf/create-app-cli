...
const downloadLocal = exports.downloadLocal = (() => {
    var _ref = _asyncToGenerator(function* (templateName, projectName) {
        ...
        console.log('--downloadLocal-templateConfig--', _templates2.default);
        ...
        if (hasTemplate) {
            api = `${_templates2.default[templateName].type}:${_templates2.default[templateName].user}/${_templates2.default[templateName].repository}#${_templates2.default[templateName].branch}`;
        }
